...
def extract_fees_with_gpt4o(text: str, broker_name: str, api_key: str, model: str = "claude-sonnet-4-6") -> list[dict]:
...
def generate_multi_broker_summary(brokers: list[Broker], fee_records: list[dict], api_key: str, model: str = "claude-sonnet-4-6") -> str:
